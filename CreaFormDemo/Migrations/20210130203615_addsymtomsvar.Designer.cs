...
namespace CreaFormDemo.Migrations
{
    ...
    [Migration("20210130203615_addsymtomsvar")]
    partial class addsymtomsvar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CreaFormDemo.Entitys.Symptoms.ClientSymptom", b =>
                {
                    b.HasOne("CreaFormDemo.Entitys.Users.Client", "Client")
                        .WithOne("clientSymptom")
                        .HasForeignKey("CreaFormDemo.Entitys.Symptoms.ClientSymptom", "ClientID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
